          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 group-hover:bg-white rounded-xl flex items-center justify-center text-primary transition-colors duration-500 mb-6 transform group-hover:scale-110">
                  <i className={`fas ${service.icon} text-2xl`}></i>
                </div>
                <h4 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-white mb-4 transition-colors duration-500">
                  {service.title}
                </h4>
