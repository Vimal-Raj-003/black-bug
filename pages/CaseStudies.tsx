          ...
          <section className="relative text-center py-16 md:py-32 bg-slate-900 rounded-b-[40px] overflow-hidden">
            ...
            <div className="relative z-10 px-4">
              ...
              <p className="mt-6 max-w-3xl mx-auto text-lg text-slate-300 drop-shadow-md">
                Explore how Hexuno Technologies helps innovative companies streamline sourcing and accelerate production with data-backed case studies.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-400">
                  Learn how a leading aerospace manufacturer leveraged Hexuno Technologies's network to source precision-machined turbine components in record time, bypassing traditional supply chain bottlenecks.
                </p>
      ...
      <div className="bg-white dark:bg-background-dark py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-background-light dark:bg-gray-800/50 p-12 rounded-2xl text-center border border-gray-200 dark:border-gray-700/50">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-gray-600 dark:text-gray-400">Join hundreds of manufacturing leaders who trust Hexuno Technologies to deliver quality parts on time.</p>
